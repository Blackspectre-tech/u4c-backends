...
class Project(TimeStamps, models.Model):
    ...
    longitude = models.DecimalField(max_digits=65, decimal_places=6, null=True, blank=True)
    latitude = models.DecimalField(max_digits=65, decimal_places=6, null=True, blank=True)
